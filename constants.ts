...
export const POINTS_CONFIG: Record<Rating, number> = {
  'Niedrig': 1,
  'Mittel': 2,
  'Hoch': 3,
  'Sehr Hoch': 5,
...
export const RATING_STYLES: Record<Rating, { text: string; bg: string }> = {
...
export const INITIAL_CRITERIA: Criterion[] = [
  {
    ...
    getRating: (value) => value as 'Niedrig' | 'Mittel' | 'Hoch',
  },
  {
    id: 2,
